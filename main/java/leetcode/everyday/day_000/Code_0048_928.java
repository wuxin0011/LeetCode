 ...
 * 928. 尽量减少恶意软件的传播 II
 *
 * 给定一个由 n 个节点组成的网络，用 n x n 个邻接矩阵graph表示。
 * 在节点网络中，只有当graph[i][j] = 1时，节点i能够直接连接到另一个节点j。
 ...
 */
public class Code_0048_928 {

    public static void main(String[] args) {
        IoUtil.testUtil(Code_0048_928.class,"minMalwareSpread","txt_file\\Code_0048_928.txt");
    }
